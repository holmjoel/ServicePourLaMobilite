...
public abstract class MoneyActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		SharedPreferences settings = getSharedPreferences("user_data",
				MODE_PRIVATE);
		if (!(settings.contains("userId"))
				&& !(this.getClass().getName()
						.equals("fr.isep.mobilemoney.LoginActivity"))) {
	...
	public void goToScreen(int id, String message) {
		...
		case R.id.withdrawal:
			activityIntent = new Intent(this, Withdrawal.class);
			break;
		...
		case R.id.help:
			activityIntent = new Intent(this, Help.class);
			break;

		case R.id.invite:
			activityIntent = new Intent(this, InviteFriend.class);
			break;
